            ...
            <ul className="space-y-4" role="list">
              ...
              <li className="flex items-start gap-3 text-sm text-white/70">
                ...
                <span>
                  ...
                  <br />
                  <span className="text-secondary-light">{company.workingHours.emergency}</span>
                </span>
              </li>
            </ul>
          </div>
        ...
        <div className="mt-16 space-y-8 border-t border-white/10 pt-12">
          <section id="privacy" aria-labelledby="privacy-heading">
            ...
            <p className="max-w-3xl text-xs leading-relaxed text-white/50">
              ...
              and retained only as long as necessary to fulfil our service obligations.
            </p>
          </section>
          <section id="terms" aria-labelledby="terms-heading">
            ...
            <p className="max-w-3xl text-xs leading-relaxed text-white/50">
              ...
              usage patterns. Warranty terms are as specified by equipment manufacturers and our
